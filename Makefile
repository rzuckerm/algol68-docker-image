ALGOL68_VERSION := $(shell cat ALGOL68_VERSION)
ALGOL68_DEPS := $(wildcard ALGOL68_*)
DOCKER_TAG_PREFIX := rzuckerm/algol68:$(ALGOL68_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(ALGOL68_DEPS)
...
$(META_BUILDX_TARGET): $(META_CREATE_BUILDER_TARGET) Dockerfile Makefile $(ALGOL68_DEPS)
